...
class byte_array(_object):
    ...
    def __init__(self, *args): 
        this = LeapPython.new_byte_array(*args)
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = LeapPython.delete_byte_array
    __del__ = lambda self : None;
    def __getitem__(self, *args): return LeapPython.byte_array___getitem__(self, *args)
    def __setitem__(self, *args): return LeapPython.byte_array___setitem__(self, *args)
    def cast(self): return LeapPython.byte_array_cast(self)
    __swig_getmethods__["frompointer"] = lambda x: LeapPython.byte_array_frompointer
    if _newclass:frompointer = staticmethod(LeapPython.byte_array_frompointer)
byte_array_swigregister = LeapPython.byte_array_swigregister
byte_array_swigregister(byte_array)

def byte_array_frompointer(*args):
  return LeapPython.byte_array_frompointer(*args)
...
class float_array(_object):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        this = LeapPython.new_float_array(*args)
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = LeapPython.delete_float_array
    __del__ = lambda self : None;
    def __getitem__(self, *args): return LeapPython.float_array___getitem__(self, *args)
    def __setitem__(self, *args): return LeapPython.float_array___setitem__(self, *args)
    def cast(self): return LeapPython.float_array_cast(self)
    __swig_getmethods__["frompointer"] = lambda x: LeapPython.float_array_frompointer
    if _newclass:frompointer = staticmethod(LeapPython.float_array_frompointer)
float_array_swigregister = LeapPython.float_array_swigregister
float_array_swigregister(float_array)

def float_array_frompointer(*args):
  return LeapPython.float_array_frompointer(*args)
...
class Pointable(Interface):
    ...
    if _newclass:is_extended = _swig_property(LeapPython.Pointable_is_extended_get)
...
class Arm(Interface):
    ...
    def __eq__(self, *args): return LeapPython.Arm___eq__(self, *args)
    def __ne__(self, *args): return LeapPython.Arm___ne__(self, *args)
    def __str__(self): return LeapPython.Arm___str__(self)
    __swig_getmethods__["width"] = LeapPython.Arm_width_get
    if _newclass:width = _swig_property(LeapPython.Arm_width_get)
    __swig_getmethods__["center"] = LeapPython.Arm_center_get
    if _newclass:center = _swig_property(LeapPython.Arm_center_get)
    __swig_getmethods__["direction"] = LeapPython.Arm_direction_get
    if _newclass:direction = _swig_property(LeapPython.Arm_direction_get)
    __swig_getmethods__["basis"] = LeapPython.Arm_basis_get
    if _newclass:basis = _swig_property(LeapPython.Arm_basis_get)
    __swig_getmethods__["elbow_position"] = LeapPython.Arm_elbow_position_get
    if _newclass:elbow_position = _swig_property(LeapPython.Arm_elbow_position_get)
    __swig_getmethods__["wrist_position"] = LeapPython.Arm_wrist_position_get
    if _newclass:wrist_position = _swig_property(LeapPython.Arm_wrist_position_get)
    __swig_getmethods__["is_valid"] = LeapPython.Arm_is_valid_get
    if _newclass:is_valid = _swig_property(LeapPython.Arm_is_valid_get)
...
class Bone(Interface):
    ...
    def __eq__(self, *args): return LeapPython.Bone___eq__(self, *args)
    def __ne__(self, *args): return LeapPython.Bone___ne__(self, *args)
    def __str__(self): return LeapPython.Bone___str__(self)
    __swig_getmethods__["prev_joint"] = LeapPython.Bone_prev_joint_get
    if _newclass:prev_joint = _swig_property(LeapPython.Bone_prev_joint_get)
    __swig_getmethods__["next_joint"] = LeapPython.Bone_next_joint_get
    if _newclass:next_joint = _swig_property(LeapPython.Bone_next_joint_get)
    __swig_getmethods__["center"] = LeapPython.Bone_center_get
    if _newclass:center = _swig_property(LeapPython.Bone_center_get)
    __swig_getmethods__["direction"] = LeapPython.Bone_direction_get
    if _newclass:direction = _swig_property(LeapPython.Bone_direction_get)
    __swig_getmethods__["length"] = LeapPython.Bone_length_get
    if _newclass:length = _swig_property(LeapPython.Bone_length_get)
    __swig_getmethods__["width"] = LeapPython.Bone_width_get
    if _newclass:width = _swig_property(LeapPython.Bone_width_get)
    __swig_getmethods__["type"] = LeapPython.Bone_type_get
    if _newclass:type = _swig_property(LeapPython.Bone_type_get)
    __swig_getmethods__["basis"] = LeapPython.Bone_basis_get
    if _newclass:basis = _swig_property(LeapPython.Bone_basis_get)
    __swig_getmethods__["is_valid"] = LeapPython.Bone_is_valid_get
    if _newclass:is_valid = _swig_property(LeapPython.Bone_is_valid_get)
...
class Finger(Pointable):
    ...
    def joint_position(self, *args): return LeapPython.Finger_joint_position(self, *args)
    def bone(self, *args): return LeapPython.Finger_bone(self, *args)
    def type(self): return LeapPython.Finger_type(self)
...
class Hand(Interface):
    ...
    if _newclass:basis = _swig_property(LeapPython.Hand_basis_get)
    ...
    if _newclass:grab_strength = _swig_property(LeapPython.Hand_grab_strength_get)
    __swig_getmethods__["pinch_strength"] = LeapPython.Hand_pinch_strength_get
    if _newclass:pinch_strength = _swig_property(LeapPython.Hand_pinch_strength_get)
    __swig_getmethods__["palm_width"] = LeapPython.Hand_palm_width_get
    if _newclass:palm_width = _swig_property(LeapPython.Hand_palm_width_get)
    ...
    if _newclass:wrist_position = _swig_property(LeapPython.Hand_wrist_position_get)
    ...
    if _newclass:confidence = _swig_property(LeapPython.Hand_confidence_get)
    __swig_getmethods__["is_left"] = LeapPython.Hand_is_left_get
    if _newclass:is_left = _swig_property(LeapPython.Hand_is_left_get)
    __swig_getmethods__["is_right"] = LeapPython.Hand_is_right_get
    if _newclass:is_right = _swig_property(LeapPython.Hand_is_right_get)
    ...
    if _newclass:arm = _swig_property(LeapPython.Hand_arm_get)
...
class Device(Interface):
    ...
    if _newclass:is_embedded = _swig_property(LeapPython.Device_is_embedded_get)
    __swig_getmethods__["is_streaming"] = LeapPython.Device_is_streaming_get
    if _newclass:is_streaming = _swig_property(LeapPython.Device_is_streaming_get)
    __swig_getmethods__["is_flipped"] = LeapPython.Device_is_flipped_get
    if _newclass:is_flipped = _swig_property(LeapPython.Device_is_flipped_get)
    __swig_getmethods__["type"] = LeapPython.Device_type_get
    if _newclass:type = _swig_property(LeapPython.Device_type_get)
...
class Image(Interface):
    ...
    def data(self, *args): return LeapPython.Image_data(self, *args)
    def distortion(self, *args): return LeapPython.Image_distortion(self, *args)
    def rectify(self, *args): return LeapPython.Image_rectify(self, *args)
    def warp(self, *args): return LeapPython.Image_warp(self, *args)
    def __eq__(self, *args): return LeapPython.Image___eq__(self, *args)
    def __ne__(self, *args): return LeapPython.Image___ne__(self, *args)
    def __str__(self): return LeapPython.Image___str__(self)
    __swig_getmethods__["id"] = LeapPython.Image_id_get
    if _newclass:id = _swig_property(LeapPython.Image_id_get)
    __swig_getmethods__["width"] = LeapPython.Image_width_get
    if _newclass:width = _swig_property(LeapPython.Image_width_get)
    __swig_getmethods__["height"] = LeapPython.Image_height_get
    if _newclass:height = _swig_property(LeapPython.Image_height_get)
    __swig_getmethods__["distortion_width"] = LeapPython.Image_distortion_width_get
    if _newclass:distortion_width = _swig_property(LeapPython.Image_distortion_width_get)
    __swig_getmethods__["distortion_height"] = LeapPython.Image_distortion_height_get
    if _newclass:distortion_height = _swig_property(LeapPython.Image_distortion_height_get)
    __swig_getmethods__["ray_offset_x"] = LeapPython.Image_ray_offset_x_get
    if _newclass:ray_offset_x = _swig_property(LeapPython.Image_ray_offset_x_get)
    __swig_getmethods__["ray_offset_y"] = LeapPython.Image_ray_offset_y_get
    if _newclass:ray_offset_y = _swig_property(LeapPython.Image_ray_offset_y_get)
    __swig_getmethods__["ray_scale_x"] = LeapPython.Image_ray_scale_x_get
    if _newclass:ray_scale_x = _swig_property(LeapPython.Image_ray_scale_x_get)
    __swig_getmethods__["ray_scale_y"] = LeapPython.Image_ray_scale_y_get
    if _newclass:ray_scale_y = _swig_property(LeapPython.Image_ray_scale_y_get)
    __swig_getmethods__["is_valid"] = LeapPython.Image_is_valid_get
    if _newclass:is_valid = _swig_property(LeapPython.Image_is_valid_get)
    def data(self):
...
class PointableList(Interface):
    ...
    def extended(self): return LeapPython.PointableList_extended(self)
...
class FingerList(Interface):
    ...
    def extended(self): return LeapPython.FingerList_extended(self)
    def finger_type(self, *args): return LeapPython.FingerList_finger_type(self, *args)
...
class ImageList(Interface):
    ...
    def __len__(self): return LeapPython.ImageList___len__(self)
    def __getitem__(self, *args): return LeapPython.ImageList___getitem__(self, *args)
    def append(self, *args): return LeapPython.ImageList_append(self, *args)
    __swig_getmethods__["is_empty"] = LeapPython.ImageList_is_empty_get
    if _newclass:is_empty = _swig_property(LeapPython.ImageList_is_empty_get)
    def __iter__(self):
      _pos = 0
      while _pos < len(self):
        yield self[_pos]
...
class Frame(Interface):
    ...
    def serialize(self, *args): return LeapPython.Frame_serialize(self, *args)
    def deserialize(self, *args): return LeapPython.Frame_deserialize(self, *args)
    ...
    if _newclass:images = _swig_property(LeapPython.Frame_images_get)
    ...
    if _newclass:serialize_length = _swig_property(LeapPython.Frame_serialize_length_get)
    def serialize(self):
...
class Controller(Interface):
    ...
    def is_service_connected(self): return LeapPython.Controller_is_service_connected(self)
...
class Listener(_object):
    ...
    def on_service_connect(self, *args): return LeapPython.Listener_on_service_connect(self, *args)
    def on_service_disconnect(self, *args): return LeapPython.Listener_on_service_disconnect(self, *args)
    def on_device_change(self, *args): return LeapPython.Listener_on_device_change(self, *args)
    def __disown__(self):
        self.this.disown()
